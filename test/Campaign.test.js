...
beforeEach(async () => {
    ...
    factory = await new web3.eth.Contract(compileFactory.abi)
...
describe('Campaigns tests', () => {
    ...
    it('allows people to contribute money and mars them as approver', async () => {
        await campaign.methods.contribute().send({
            value: '200',
            from: accounts[1] //By default ganache create 10 accounts
        });
